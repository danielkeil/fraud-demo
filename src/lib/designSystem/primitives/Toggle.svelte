...
<div class="flex items-center gap-3 {variantStyles[variant]} {className}">
	<Switch.Root
		...
		{disabled}
		{onCheckedChange}
		class="relative inline-flex h-6 w-10 shrink-0 cursor-pointer items-center rounded-full bg-zinc-200 transition-colors outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:bg-yellow-400"
	>
		<Switch.Thumb
