				...
				<DropdownMenu.Root bind:open={menuOpen}>
					...
					<DropdownMenu.Portal>
						<DropdownMenu.Content
							class="z-50 w-[var(--bits-dropdown-menu-anchor-width)] hover:ring-zinc-900/5 rounded-lg bg-white p-1 ring-1 ring-zinc-900/5 focus:outline-yellow-400"
							sideOffset={8}
							side="top"
						>
							<DropdownMenu.Item
							...
							<DropdownMenu.Item
								class="group flex cursor-pointer items-center gap-3 rounded-md px-2 py-2 text-sm/5 text-zinc-900 hover:bg-gray-100 focus:bg-grey-100 focus:outline-2 focus:outline-yellow-400"
							>
								<LogOut class="size-5 text-zinc-500 group-hover:text-yellow-400 group-focus:text-yellow-400" />
								Abmelden
							</DropdownMenu.Item>
						</DropdownMenu.Content>
					</DropdownMenu.Portal>
