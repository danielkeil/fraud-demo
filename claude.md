...
- For managing URL query parameters with `useSearchParams` from `runed/kit`, see [search-params](./doc/ai/search-params.md)
...
- When working with URL query/search parameters, use `useSearchParams` from `runed/kit` - read `./doc/ai/search-params.md` first
